...
<div class="register">
  ...
  <section class="terms-conditions">
    ...
    <div id="grab-info" class="info-box" style="display: none;">
      ...
      <p>
        <strong>Route:</strong><br>
        -> Use Grab or similar apps and input Bagpi Garment Center, Taytay or Taytay New Market as your destination.<br><br>
